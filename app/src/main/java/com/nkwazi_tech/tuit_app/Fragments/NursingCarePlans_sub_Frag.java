...
public class NursingCarePlans_sub_Frag extends Fragment {
public static String Sub;
    ...
    private void LoadHeader() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URLs.URL_Subloadheader+"&header="+Sub,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Adapter_GeneralResearchList adapter = new Adapter_GeneralResearchList(getContext(), dataHandler_generalResearches,"sub", Sub);
