...
public class LibraryPdf_Frag extends Fragment {
    ...
    public static String LoadCourse,loadresearch;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        subscription= root.findViewById(R.id.textView80);
    ...
    private void loadProducts() {
        ...
        class AddComment extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                if (loadresearch != null){
                    params.put("loadresearch", loadresearch);
                    loadresearch = null;
                }else{
                    int user_id = SharedPrefManager.getInstance(getContext()).getID();
                    params.put("library", LoadCourse);
                    params.put("userid", String.valueOf(user_id));
                }
                return requestHandler.sendPostRequest(URLs.URL_getCarepans, params);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    //creating adapter object and setting it to recyclerview7
                    //passing subscription price and account balance
                    if (loadresearch == null){
                        Adapter_Library.course_price = obj.getString("subscription_price");
                        Adapter_Library.user_balance = obj.getString("balance");
                        Adapter_Library.course_name = obj.getString("coursename");
                        Adapter_Library.course_img = obj.getString("courseimg");
                        Adapter_Library.course_id = obj.getString("courseid");
                    }
                    adapter = new Adapter_Library(getContext(), dataHandler_careplans, "Edit");
                    ...
                    if (adapter.getItemCount() == 0) {
                        ...
                        nofile.setText("No books available for this course");
                    }
